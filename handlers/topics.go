...
func fetchTopics(ctx context.Context, cfg config.Config, topicAPIClient clients.TopicAPIClient, topics []string, userAccessToken string) []topicAPIModels.Topic {
