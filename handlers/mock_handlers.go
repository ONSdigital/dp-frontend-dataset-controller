...
func (m *MockFilterClient) CreateBlueprint(ctx context.Context, serviceAuthToken, downloadServiceToken, datasetID, edition, version string, names []string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBlueprint", ctx, serviceAuthToken, downloadServiceToken, datasetID, edition, version, names)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockFilterClientMockRecorder) CreateBlueprint(ctx, serviceAuthToken, downloadServiceToken, datasetID, edition, version, names interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBlueprint", reflect.TypeOf((*MockFilterClient)(nil).CreateBlueprint), ctx, serviceAuthToken, downloadServiceToken, datasetID, edition, version, names)
}
...
func (m *MockDatasetClient) Get(ctx context.Context, userAuthToken, serviceAuthToken, collectionID, datasetID string) (dataset.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatasetClient) GetByPath(ctx context.Context, userAuthToken, serviceAuthToken, collectionID, path string) (dataset.Model, error) {
	m.ctrl.T.Helper()
